...
PKL_OUTPUT = os.path.join(BASE_DIR, "classifier_clothing.pkl")
...
dataset_path = os.path.join(BASE_DIR, "images_moniter", "clothing ")
...
if __name__ == "__main__":
    print("Training clothing classifier on 100% of data...")
    clf = train_classifier()
    print("\nDone! classifier_clothing.pkl ready.")
