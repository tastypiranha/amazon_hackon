...
PKL_OUTPUT = os.path.join(BASE_DIR, "classifier_household.pkl")
...
dataset_path = os.path.join(BASE_DIR, "images_moniter", "household utensils")
...
if __name__ == "__main__":
    print("Training household utensils classifier on 100% of data...")
    clf = train_classifier()
    print("\nDone! classifier_household.pkl ready.")
